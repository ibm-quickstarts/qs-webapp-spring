...
Follow the [README](https://github.com/IBM-Cloud/Scalable-web-app-java/tree/master/terraform/README.md) instructions for creating and deploying your application via IBM Cloud Schematics, which uses Terraform templates to create an IKS cluster and IBM Cloud DevOps toolchain. 
